                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link nav-active" href="#"><i class="bi bi-box-seam"></i> Package</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item d-lg-none d-sm-block">
                                <a type="button" class="nav-link" href="../PHP/insertSession.php"><i class=" bi bi-plus-square"></i> Add Package</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="container d-none d-lg-block bg-skyblue">
                            ...
                            <div class="row">
                                <div class="col text-right pb-3">
                                    <a class="ml-auto btn btn-primary rounded mr-auto" href="../PHP/insertSession.php"><i class="bi bi-plus-square"></i> Add Package</a>
                                </div>
                            </div>
                        </div>
                    </div>
